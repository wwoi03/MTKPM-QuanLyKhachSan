document.addEventListener('DOMContentLoaded', function () {
	...
	function main() {
		$.ajax({
			type: "GET",
			url: "/Admin/AdminBookingProxy/GetBooking",
	...
	function booking() {
		$.ajax({
			type: "GET",
			url: "/Admin/AdminBookingProxy/Booking",
			success: function (data) {
	...
	function bookingDetails(bookRoomDetailsId) {
		$.ajax({
			type: "GET",
			url: "/Admin/AdminBookingProxy/BookingDetails?bookRoomDetailsId=" + bookRoomDetailsId,
			success: function (data) {
				$(".right-panel").html(data);
	...
	function editBooking() {
		document.getElementById('form-book-room').addEventListener('submit', function (e) {
			...
			$.ajax({
				type: "POST",
				url: "/Admin/AdminBookingProxy/EditBooking",
				data: $(this).serialize(),
				success: function (data) {
					if (data.result == true) {
						success(
	...
	function addRoomBooking() {
		document.querySelector('.panel-form-add-room').addEventListener('click', function () {
			$.ajax({
				type: "POST",
				url: "/Admin/AdminBookingProxy/ChooseRoom",
				success: function (data) {
