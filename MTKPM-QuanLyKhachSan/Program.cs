...
//builder.Services.AddScoped<StrategyDatabase, Under5HundredRoom>("LuxuryRooms");
//builder.Services.AddScoped<StrategyDatabase, DoubleRooms>("DoubleRooms");
//builder.Services.AddScoped<StrategyDatabase, StandardRooms>("StandardRooms");
