...
namespace MTKPM_QuanLyKhachSan.Areas.Admin.Controllers
{
	...
	public class AdminRoomController : Controller
	{
		...
		public AdminRoomController(DatabaseContext context, IService myService, Under5HundredRoom under5HundredRoom, DoubleRooms doubleRoom, StandardRooms standardRooms)
		{
		...
		{
			ViewBag.Room = roomDao.GetRooms(myService.GetHotelId());
			return View();
		}
